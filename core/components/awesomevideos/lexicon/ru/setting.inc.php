...
/* Frontend */
$_lang['setting_awesomeVideos.frontend.css'] = 'Стили фронтенда';
$_lang['setting_awesomeVideos.frontend.css_desc'] = 'Путь к файлу со основными стилями. Если вы хотите использовать собственные стили - укажите путь к ним здесь, или очистите параметр и загрузите их вручную через шаблон сайта.';
$_lang['setting_awesomeVideos.frontend.js'] = 'Скрипты фронтенда';
$_lang['setting_awesomeVideos.frontend.js_desc'] = 'Загружать основные скрипты?';