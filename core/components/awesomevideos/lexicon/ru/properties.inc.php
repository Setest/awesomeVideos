...
$_lang['awesomeVideos_prop_idx'] = 'Список ID ресурсов через запятую, которые обязательны для вывода, если добавить знак "-" перед ресурсом,
то он будет исключен из выборки.';
...
$_lang['awesomeVideos_prop_tplPagingButton'] = 'Имя чанки кнопки выполняющую для получения ресурсов';
